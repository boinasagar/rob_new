 ...
 */
	Configure::write('Security.salt', 'rmg21072014DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '2107201476859309657453542496749683645');
