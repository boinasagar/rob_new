<div class="promoCodes index">
	...
	<tr>
		...
		<td><?php echo h($promoCode['PromoCode']['promo_code_cat']); ?>&nbsp;</td>
		<td><?php echo h($promoCode['PromoCode']['notes']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $promoCode['PromoCode']['id']), array(), __('Are you sure you want to delete # %s?', $promoCode['PromoCode']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
